...
class Player {
    constructor(id, name, skinPath, position) {
        ...
        this.precedenteX = this.finalX;
        this.precedenteY = this.finalY;
        this.renderX = this.finalX;
        this.renderY = this.finalY;
    }
    ...
    update(updateData) {
        ...
        this.precedenteX = this.finalX;
        this.precedenteY = this.finalY;
        [this.finalX, this.finalY] = updateData.position;
    ...
    interpolate(alpha) {
    console.log("--------------------");
    this.renderX = this.precedenteX + (this.finalX - this.precedenteX) * alpha;
    this.renderY = this.precedenteY + (this.finalY - this.precedenteY) * alpha;
